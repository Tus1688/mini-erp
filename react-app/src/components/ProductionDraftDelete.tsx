...
const ProductionDraftDelete = ({
    ...
    const deleteProductionDraft = async (id: number) => {
    ...
    return (
        <EuiModal onClose={() => toggleModal(false)}>
            <EuiModalHeader>
                <EuiModalHeaderTitle>
                    <h2>Delete production draft</h2>
                </EuiModalHeaderTitle>
            </EuiModalHeader>
            <EuiModalBody>
                <EuiText>
                    <p>
                        You&rsquo;re about to delete production draft
                        <br />
            ...
            <EuiModalFooter>
                ...
                <EuiButton onClick={() => deleteProductionDraft(id)} fill color='danger'>
                    Yes, delete it!
                </EuiButton>
            </EuiModalFooter>
            <EuiGlobalToastList
...
export default ProductionDraftDelete;
